      ...
      <div className={siteContentFrame}>
        ...
        <div className="mt-14 grid gap-10 md:grid-cols-2">
          {services.map((service, index) => (
            <FadeIn key={service.title} delayMs={90 * index} className="flex flex-col border border-border bg-surface/60 px-8 py-10">
              ...
              <div className="mt-10 mt-auto pt-10">
                ...
                <Link
                  href={service.href}
                  className="inline-flex mt-8 border-b border-transparent pb-[2px] font-body font-light text-olive transition-colors hover:border-olive"
                >
                  Read more softly
                </Link>
              </div>
        ...
        <FadeIn delayMs={120} className="mt-16">
          <Link
            href="/services"
            className="border-b border-olive/40 pb-[2px] font-body font-light text-olive-dark transition-colors hover:border-olive"
          >
